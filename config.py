from dotenv import load_dotenv # allows us to load env variable to do certain things with our app
import os
from datetime import timedelta

basedir = os.path.abspath(os.path.dirname(__file__)) # this is estab. our base directory or our root folder
...
class Config():
    ...
    '''
    FLASK_APP = os.environ.get('FLASK_APP') # looking for key of Flask_APP in our .env file 
